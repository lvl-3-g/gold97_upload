...
.ku_gu:    db GLOOM, TURBAN, GLIGAR, KRABBY, QUAGSIRE, CROBAT, -1
...
.ne:       db NATU, XATU, -1
.no:       db PARA, -1
.ha_ba_pa: db SEEL, STEELIX, DYNABEAR, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, MILTANK, PARAS, PARASECT, PLUCKROSS, MR__MIME, TYROGUE, CLOYSTER, LICKYLICKY, -1
