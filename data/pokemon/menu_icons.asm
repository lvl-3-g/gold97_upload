...
MonMenuIcons:
	...
	db ICON_MONSTER     ; CYNDAQUIL
	db ICON_MONSTER     ; QUILAVA
	db ICON_MONSTER     ; TYPHLOSION
	db ICON_LAPRAS      ; TOTODILE
	db ICON_LAPRAS      ; CROCONAW
	db ICON_LAPRAS      ; FERALIGATR
	db ICON_ODDISH      ; SENTRET
	db ICON_ODDISH      ; FURRET
	...
	db ICON_BLOB        ; FORRETRESS
	db ICON_BUG         ; DUNSPARCE
	db ICON_BLOB        ; GLIGAR
	db ICON_SERPENT     ; STEELIX
	db ICON_MONSTER     ; SNUBBULL
	db ICON_FISH        ; GRANBULL
	db ICON_BUG         ; QWILFISH
	db ICON_BUG         ; SCIZOR
	db ICON_FOX         ; SHUCKLE
	db ICON_FOX         ; HERACROSS
	db ICON_FOX         ; SNEASEL
	db ICON_FISH        ; TEDDIURSA
	db ICON_FISH        ; URSARING
	db ICON_FOX         ; SLUGMA
	db ICON_BIRD        ; MAGCARGO
	db ICON_GHOST       ; SWINUB
	db ICON_GHOST       ; PILOSWINE
	db ICON_FOX         ; CORSOLA
	...
	db ICON_BIRD        ; MILTANK actually chix
	db ICON_EQUINE      ; BLISSEY actually miltank
	db ICON_FOX         ; RAIKOU
	db ICON_FOX         ; ENTEI
	db ICON_FOX         ; SUICUNE
	...
	db ICON_CLEFAIRY    ; LUGIA actually blissey
	db ICON_HO_OH       ; HO_OH
	db ICON_FOX		    ; CELEBI
