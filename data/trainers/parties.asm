...
ErikaGroup:
	...
	db 36, PIKACHU,    CHARM, QUICK_ATTACK, THUNDERBOLT, THUNDER_WAVE
	db 35, ESPEON,     MUD_SLAP, REFLECT, SWIFT, PSYBEAM
	db 33, SNORLAX,    AMNESIA, SNORE, REST, BODY_SLAM
	db 34, VENUSAUR,   SUNNY_DAY, MEGA_DRAIN, SYNTHESIS, SOLARBEAM
	db 36, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, FIRE_SPIN
	db 36, BLASTOISE,  RAIN_DANCE, SURF, ICE_PUNCH, WHIRLPOOL
	db -1 ; end
