...
BugsyGroup:
	...
	db 16, PLUCKROSS,    VICEGRIP, FOCUS_ENERGY, FURY_CUTTER, NO_MOVE
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "ENOKI@", TRAINERTYPE_MOVES; used
	db 19, CURSTRAW,     PSYWAVE, SPITE, CONFUSE_RAY, MEAN_LOOK
...
PryceGroup:
	...
	db 23, WOLFAN,       POWDER_SNOW, ICY_WIND, SWAGGER, REST
...
ChuckGroup:
	...
	db 31, WARFARU,  ICY_WIND, SWIFT, CRUNCH, HYPER_BEAM
	db -1 ; end
...
Rival1Group:
	...
	db 17, BOMSEAL,  DOUBLE_TEAM, WATER_GUN, FLAME_WHEEL, NO_MOVE
	db 18, BLOSSOMOLE,    GROWL, REFLECT, RAZOR_LEAF, POISONPOWDER
	db -1 ; end
	...
	db 17, RINRING,    HEADBUTT, BITE, GROWL, SWIFT
	db 17, BOMSEAL,  DOUBLE_TEAM, WATER_GUN, FLAME_WHEEL, NO_MOVE
	db 18, VOLBEAR,    LEER, SMOKESCREEN, EMBER, BITE
	db -1 ; end
	...
	db 17, RINRING,    HEADBUTT, BITE, GROWL, SWIFT
	db 17, BOMSEAL,  DOUBLE_TEAM, WATER_GUN, FLAME_WHEEL, NO_MOVE
	db 18, AQUALLO,   LEER, POWDER_SNOW, WATER_GUN, STRENGTH
	db -1 ; end
	...
	db 30, BLOSSOMOLE,   SYNTHESIS, REFLECT, RAZOR_LEAF, POISONPOWDER;blossomole
	db -1 ; end
	...
	db 28, BOMSEAL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, NO_MOVE;bomseal
	db 29, KOTORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;kotora
	db 30, VOLBEAR,    SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 28, BOMSEAL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, NO_MOVE;bomseal
	db 29, KOTORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;kotora
	db 30, AQUALLO, AGILITY, ICY_WIND, SURF, IRON_TAIL
	db -1 ; end
	...
	db 38, BLOSSOMITE,   SYNTHESIS, REFLECT, RAZOR_LEAF, SOLARBEAM;blossomite
	db 37, CURPAN,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
	...
	db 36, BOMSEAL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 37, RAITORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;raitora
	db 38, DYNABEAR,    SMOKESCREEN, FLAME_WHEEL, QUICK_ATTACK, FLAMETHROWER
	db 37, CURPAN,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
	...
	db 36, BOMSEAL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 37, RAITORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;raitora
	db 38, AQUARIUS, AGILITY, ICY_WIND, SURF, BUBBLEBEAM
	db 37, CURPAN,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
...
KarenGroup:
	...
	db 46, GROTESS,   ENDURE, BLIZZARD, BUBBLEBEAM, SUPERSONIC; grotess
...
BrockGroup:
	...
	db 36, KANGASKHAN, COMET_PUNCH, RAGE, BITE, TAIL_WHIP
	db 36, RHYHORN,    HORN_ATTACK, STOMP, TAIL_WHIP, TAKE_DOWN
	db 37, NIDOKING,   HORN_ATTACK, POISON_STING, FURY_ATTACK, FOCUS_ENERGY
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 71, GROTESS, BIDE, ICY_WIND, BUBBLEBEAM, HYDRO_PUMP
...
CooltrainerFGroup:
	...
	db 38, LICKYLICKY,  NO_ITEM,      STOMP, DISABLE, HYPER_BEAM, ENDURE
	db -1 ; end
...
BeautyGroup:
	...
	db 15, MEOWSY,     SCRATCH, GROWL, BITE, PAY_DAY
...
FisherGroup:
	...
	db 35, NUMBPUFF,   TOXIC, MINIMIZE, SURF, PIN_MISSILE
...
Rival2Group:
	...
	db 48, RAITORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;raitora
	db 50, BLOSSOMITE,   SYNTHESIS, REFLECT, RAZOR_LEAF, SOLARBEAM;blossomite
	...
	db 50, BOMSEAL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 48, RAITORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;raitora
	db 50, DYNABEAR,    SMOKESCREEN, FLAME_WHEEL, QUICK_ATTACK, FLAMETHROWER
	db 48, CURPAN,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
	...
	db 50, BOMSEAL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 48, RAITORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;raitora
	db 50, AQUARIUS, AGILITY, ICY_WIND, SURF, BUBBLEBEAM
	db 48, CURPAN,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 19, CURSTRAW,   MEAN_LOOK, CONFUSE_RAY, PSYWAVE, SPITE
	...
	db 30, CURPAN,   MEAN_LOOK, CONFUSE_RAY, PSYBEAM, SWAGGER
	db -1 ; end
	...
	db 32, CURPAN,   MEAN_LOOK, CONFUSE_RAY, PSYBEAM, SWAGGER
	db -1 ; end
...
PsychicGroup:
	...
	db 8, MIME_JR,   BARRIER, CONFUSION, NO_MOVE, NO_MOVE
