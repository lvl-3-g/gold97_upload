...
MortyGroup:
	...
	db 19, CURSTRAW,     PSYWAVE, CURSE, CONFUSE_RAY, MEAN_LOOK
...
JasmineGroup:
	...
	db 24, STEELIX,    SCREECH, SANDSTORM, ROCK_THROW, IRON_TAIL
	db -1 ; end
...
Rival1Group:
	...
	db 30, BLOSSOMOLE,    DOUBLE_TEAM, SLEEP_POWDER, RAZOR_LEAF, STUN_SPORE;blossomole
	db -1 ; end
	...
	db 39, BLOSSOMITE,   SYNTHESIS, LEECH_SEED, RAZOR_LEAF, SOLARBEAM;blossomite
...
Rival2Group:
	...
	db 50, BLOSSOMITE,   SYNTHESIS, SLAM, RAZOR_LEAF, SOLARBEAM;blossomite
