...
FalknerGroup:
	...
	db  6, PIDGEY,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db  8, PIDGEOTTO,  TACKLE, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end
...
WhitneyGroup:
	...
	db 18, BLISSEY,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end
...
BugsyGroup:
	...
	db 16, QWILFISH,    VICEGRIP, FOCUS_ENERGY, FURY_CUTTER, NO_MOVE
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "ENOKI@", TRAINERTYPE_MOVES; used
	db 19, SWINUB,     PSYWAVE, SPITE, CONFUSE_RAY, MEAN_LOOK
	db 20, HAUNTER,    NIGHT_SHADE, SHADOW_BALL, MEAN_LOOK, CONFUSE_RAY
	db 20, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES; used
	db 23, LARVITAR,       POWDER_SNOW, ICY_WIND, SWAGGER, REST
	db 25, DEWGONG,    HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 24, CLOYSTER,  ICY_WIND, PROTECT, CLAMP, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES; used
	db 21, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 23, MAGNETON,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 24, STEELIX,    SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "OKERA@", TRAINERTYPE_MOVES
	db 30, GIRAFARIG,  CONFUSE_RAY, THIEF, THUNDERBOLT, FAINT_ATTACK
	db 28, HOUNDOOM,  BITE, IRON_TAIL, SWAGGER, SLUDGE_BOMB
	db 31, PUPITAR,  ICY_WIND, SWIFT, CRUNCH, HYPER_BEAM
	db -1 ; end
...
Rival1Group:
	...
	db 17, CHINCHOU,   THUNDER_WAVE, THUNDERSHOCK, MUD_SLAP, ENDURE
	db 17, SHUCKLE,    HEADBUTT, BITE, GROWL, SWIFT
	db 17, AZUMARILL,  DOUBLE_TEAM, WATER_GUN, FLAME_WHEEL, NO_MOVE
	...
	db 17, SHUCKLE,    HEADBUTT, BITE, GROWL, SWIFT
	db 17, AZUMARILL,  DOUBLE_TEAM, WATER_GUN, FLAME_WHEEL, NO_MOVE
	db 18, QUILAVA,    LEER, SMOKESCREEN, EMBER, BITE
	db -1 ; end
	...
	db 17, SHUCKLE,    HEADBUTT, BITE, GROWL, SWIFT
	db 17, AZUMARILL,  DOUBLE_TEAM, WATER_GUN, FLAME_WHEEL, NO_MOVE
	db 18, CROCONAW,   LEER, POWDER_SNOW, WATER_GUN, STRENGTH
	db -1 ; end

	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 28, FARFETCH_D,     SWORDS_DANCE, WING_ATTACK, FLY, SAND_ATTACK;farfetchd
	db 28, HERACROSS,  HEADBUTT, BITE, DISABLE, SWIFT;bellring
	db 28, AZUMARILL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, NO_MOVE;bomseal
	db 29, CHINCHOU,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;kotora
	db 30, BAYLEEF,   SYNTHESIS, REFLECT, RAZOR_LEAF, POISONPOWDER;blossomole
	db -1 ; end
	...
	db 28, AZUMARILL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, NO_MOVE;bomseal
	db 29, CHINCHOU,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;kotora
	db 30, QUILAVA,    SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 28, AZUMARILL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, NO_MOVE;bomseal
	db 29, CHINCHOU,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;kotora
	db 30, CROCONAW, AGILITY, ICY_WIND, SURF, IRON_TAIL
	db -1 ; end

	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 35, MAGCARGO,     SWORDS_DANCE, WING_ATTACK, FLY, AGILITY;madame
	db 36, HERACROSS,  HEADBUTT, BITE, DISABLE, FAINT_ATTACK;bellring
	db 36, AZUMARILL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 37, LANTURN,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;raitora
	db 38, MEGANIUM,   SYNTHESIS, REFLECT, RAZOR_LEAF, SOLARBEAM;blossomite
	db 37, PILOSWINE,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
	...
	db 36, AZUMARILL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 37, LANTURN,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;raitora
	db 38, TYPHLOSION,    SMOKESCREEN, FLAME_WHEEL, QUICK_ATTACK, FLAMETHROWER
	db 37, PILOSWINE,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
	...
	db 36, AZUMARILL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 37, LANTURN,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;raitora
	db 38, FERALIGATR, AGILITY, ICY_WIND, SURF, BUBBLEBEAM
	db 37, PILOSWINE,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
...
KarenGroup:
	...
	db 44, GRANBULL,    EARTHQUAKE, RAIN_DANCE, SURF, DOUBLE_TEAM; quagsire
	db 44, URSARING,   THUNDER_WAVE, THUNDERBOLT, WATERFALL, ICE_BEAM; numbpuff
	db 46, QUAGSIRE,   ENDURE, BLIZZARD, BUBBLEBEAM, SUPERSONIC; grotess
...
KogaGroup:
	...
	db 45, SUDOWOODO,  GIGA_DRAIN, SOLARBEAM, ACID, POISONPOWDER
...
BrockGroup:
	...
	db 33, NIDORINO,   HORN_ATTACK, POISON_STING, FURY_ATTACK, FOCUS_ENERGY
	db 34, KANGASKHAN, COMET_PUNCH, RAGE, BITE, TAIL_WHIP
	db 34, RHYHORN,    HORN_ATTACK, STOMP, TAIL_WHIP, TAKE_DOWN
	db 35, NIDOQUEEN,  DOUBLE_KICK, BODY_SLAM, POISON_STING, TAIL_WHIP
	db -1 ; end
...
MistyGroup:
	...
	db 42, GRANBULL,   SURF, AMNESIA, EARTHQUAKE, RAIN_DANCE
...
ErikaGroup:
	...
	db 34, PIKACHU,    CHARM, QUICK_ATTACK, THUNDERBOLT, THUNDER_WAVE
	db 33, ESPEON,     MUD_SLAP, REFLECT, SWIFT, PSYBEAM
	db 31, SNORLAX,    AMNESIA, SNORE, REST, BODY_SLAM
	db 32, VENUSAUR,   SUNNY_DAY, MEGA_DRAIN, SYNTHESIS, SOLARBEAM
	db 34, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, FIRE_SPIN
	db 34, BLASTOISE,  RAIN_DANCE, SURF, ICE_PUNCH, WHIRLPOOL
	db -1 ; end
...
SchoolboyGroup:
	...
	db 36, FURRET,    POISONPOWDER, VINE_WHIP, BIND, MEGA_DRAIN
	db 37, FURRET,    POISONPOWDER, VINE_WHIP, BIND, MEGA_DRAIN
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 42, MAGCARGO, SWORDS_DANCE, WING_ATTACK, FLY, SLASH
	db -1 ; end
...
LassGroup:
	...
	db 16, SNUBBULL,   SCARY_FACE, CHARM, BITE, LICK
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 16, LARVITAR, BITE, POWDER_SNOW, SWAGGER, PROTECT
	...
	db 33, GRANBULL,   WATER_GUN, SLAM, AMNESIA, EARTHQUAKE
	...
	db 70, SUDOWOODO, SLEEP_POWDER, POISONPOWDER, STUN_SPORE, RAZOR_LEAF
	db 71, UMBREON, SLUDGE_BOMB, TOXIC, ACID_ARMOR, CONFUSE_RAY
	db 71, QUAGSIRE, BIDE, ICY_WIND, BUBBLEBEAM, HYDRO_PUMP
...
CooltrainerFGroup:
	...
	db 37, SUDOWOODO,  SUNNY_DAY, SOLARBEAM, RAZOR_LEAF, ACID
	db -1 ; end
	...
	db 38, PUPITAR,    NO_ITEM,      ICE_PUNCH, EARTHQUAKE, CRUNCH, SCARY_FACE
	db 40, NIDOQUEEN,  PINK_BOW,     EARTHQUAKE, DOUBLE_KICK, TOXIC, BODY_SLAM
	db 38, TYRANITAR,  NO_ITEM,      STOMP, DISABLE, HYPER_BEAM, ENDURE
	db -1 ; end
...
BeautyGroup:
	...
	db 15, SLUGMA,     SCRATCH, GROWL, BITE, PAY_DAY
	db 15, MEOWTH,     SCRATCH, GROWL, BITE, SLASH
	db -1 ; end
...
SabrinaGroup:
	...
	db 28, IVYSAUR,     LEECH_SEED, RAZOR_LEAF, POISONPOWDER, SLEEP_POWDER
	db 28, WARTORTLE,   RAIN_DANCE, WATER_GUN, BITE, RAPID_SPIN
	db 28, CHARMELEON,   EMBER, SMOKESCREEN, FLAMETHROWER, RAGE
	db -1 ; end
...
BugCatcherGroup:
	...
	; BUG_CATCHER (5)
	db "BENNY@", TRAINERTYPE_NORMAL ;used, azalea gym
	db  7, DUNSPARCE
	db  9, PARAS
	db 12, PARASECT
	db -1 ; end
	...
	db 33, LEDIAN, COMET_PUNCH, SWIFT, SUPERSONIC, AGILITY
...
FisherGroup:
	...
	db 35, URSARING,   TOXIC, MINIMIZE, SURF, PIN_MISSILE
...
Rival2Group:
	; RIVAL2 (1)
	db "?@", TRAINERTYPE_MOVES
	db 49, MAGCARGO,     SWORDS_DANCE, WING_ATTACK, FLY, AGILITY;madame
	db 48, HERACROSS,  HEADBUTT, BITE, DISABLE, FAINT_ATTACK;bellring
	db 50, AZUMARILL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 48, LANTURN,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;raitora
	db 50, MEGANIUM,   SYNTHESIS, REFLECT, RAZOR_LEAF, SOLARBEAM;blossomite
	db 48, PILOSWINE,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
	...
	db 50, AZUMARILL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 48, LANTURN,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;raitora
	db 50, TYPHLOSION,    SMOKESCREEN, FLAME_WHEEL, QUICK_ATTACK, FLAMETHROWER
	db 48, PILOSWINE,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
	...
	db 50, AZUMARILL,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;bomseal
	db 48, LANTURN,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;raitora
	db 50, FERALIGATR, AGILITY, ICY_WIND, SURF, BUBBLEBEAM
	db 48, PILOSWINE,  CONFUSE_RAY, MEAN_LOOK, PSYBEAM, BODY_SLAM;curpan
	db -1 ; end
...
HikerGroup:
	...
	db 42, CHARIZARD,  GOLD_BERRY
	db 44, MAGMAR,     GOLD_BERRY
	db 45, RAPIDASH,   GOLD_BERRY
	db 45, AZUMARILL,  GOLD_BERRY
	db -1 ; end
...
BurglarGroup:
	...
	db 18, KOFFING,    TACKLE, SMOG, SLUDGE, SMOKESCREEN
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 18, KOFFING,    TACKLE, SLUDGE, SMOKESCREEN, HAZE
	db 19, SWINUB,   MEAN_LOOK, CONFUSE_RAY, PSYWAVE, SPITE
	db 21, HOUNDOOM,   EMBER, SMOG, BITE, FAINT_ATTACK
	db -1 ; end

	; EXECUTIVEM (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES; used, base b1f
	db 28, HOUNDOOM,   FLAMETHROWER, ROAR, BITE, FAINT_ATTACK
	db 31, WEEZING,    TACKLE, SLUDGE_BOMB, SMOKESCREEN, TOXIC
	db 30, PILOSWINE,   MEAN_LOOK, CONFUSE_RAY, PSYBEAM, SWAGGER
	db -1 ; end

	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 30, HOUNDOOM,   FLAMETHROWER, ROAR, BITE, FAINT_ATTACK
	db 32, WEEZING,    TACKLE, SLUDGE_BOMB, SMOKESCREEN, TOXIC
	db 32, PILOSWINE,   MEAN_LOOK, CONFUSE_RAY, PSYBEAM, SWAGGER
	db -1 ; end
...
PsychicGroup:
	...
	db 21, PINECO,     ENDURE, CLAMP, WHIRLPOOL, PROTECT
	db -1 ; end

	; PSYCHIC_T (7)
	db "MARK@", TRAINERTYPE_MOVES ;used
	db 8, STANTLER,   BARRIER, CONFUSION, NO_MOVE, NO_MOVE
	db 8, ABRA,       TELEPORT, FLASH, NO_MOVE, NO_MOVE
	db 9, KADABRA,    TELEPORT, KINESIS, CONFUSION, NO_MOVE
	db -1 ; end
...
PokefanMGroup:
	...
	db 42, VILEPLUME,  GOLD_BERRY
	db 44, SUDOWOODO,  GOLD_BERRY
	db 45, BELLOSSOM,  GOLD_BERRY
	db 45, VICTREEBEL, GOLD_BERRY
	db -1 ; end

	; POKEFANM (6)
	db "TREVOR@", TRAINERTYPE_ITEM; potential 1; used water
	db 42, MANTINE,    GOLD_BERRY
	db 44, OMASTAR,    GOLD_BERRY
	db 45, BLASTOISE,  GOLD_BERRY
	db 45, QUAGSIRE,   GOLD_BERRY
	db -1 ; end
