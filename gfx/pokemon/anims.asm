...
TwinborusAnimation:  INCLUDE "gfx/pokemon/twinborus/anim.asm"
...
WarfaruAnimation:    INCLUDE "gfx/pokemon/warfaru/anim.asm"
LickylickyAnimation:  INCLUDE "gfx/pokemon/lickylicky/anim.asm"
