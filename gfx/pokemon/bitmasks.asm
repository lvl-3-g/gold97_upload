...
TwinborusBitmasks:  INCLUDE "gfx/pokemon/twinborus/bitmask.asm"
...
WarfaruBitmasks:    INCLUDE "gfx/pokemon/warfaru/bitmask.asm"
LickylickyBitmasks:  INCLUDE "gfx/pokemon/lickylicky/bitmask.asm"
