...
TwinborusAnimationIdle:  INCLUDE "gfx/pokemon/twinborus/anim_idle.asm"
...
WarfaruAnimationIdle:    INCLUDE "gfx/pokemon/warfaru/anim_idle.asm"
LickylickyAnimationIdle:  INCLUDE "gfx/pokemon/lickylicky/anim_idle.asm"
