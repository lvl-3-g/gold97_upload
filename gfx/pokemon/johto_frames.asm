...
TwinborusFrames:  INCLUDE "gfx/pokemon/twinborus/frames.asm"
...
WarfaruFrames:    INCLUDE "gfx/pokemon/warfaru/frames.asm"
LickylickyFrames:  INCLUDE "gfx/pokemon/lickylicky/frames.asm"
