...
ElmEntrance_MapEvents:
	...
	warp_event  4, 15, NEW_BARK_TOWN, 5
	...
	object_event  4, 13, SPRITE_BLUE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ElmEntranceBlueScript, EVENT_BLUE_ELM_ENTRANCE
