...
.NoEvilLeft
	...
	setmapscene VIOLET_CITY, SCENE_KURTS_HOUSE_LOCKED
...
OlivineHouseBeta_MapEvents:
	...
	db 1 ; object events
	object_event  6,  3, SPRITE_CAPTAIN, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineHouseBetaElderScript, EVENT_VIOLET_CITY_EARL
