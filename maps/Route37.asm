...
Route37_MapEvents:
	...
	db 10 ; warp events
	warp_event  4,  0, ROUTE_29, 1
	warp_event  5,  0, ROUTE_29, 1
	warp_event  6,  0, ROUTE_29, 1
	warp_event  7,  0, ROUTE_29, 2
	warp_event  8,  0, ROUTE_29, 2
	warp_event  9,  0, ROUTE_29, 2
	warp_event 49, 28, ROUTE_29, 3
	warp_event 49, 29, ROUTE_29, 3
	warp_event 49, 30, ROUTE_29, 4
	warp_event 49, 31, ROUTE_29, 4
	
	db 0 ; coord events

	db 3 ; bg events
	bg_event 47, 28, BGEVENT_READ, Route37Sign
	bg_event  9,  4, BGEVENT_READ, Route37Sign2
	bg_event 21, 13, BGEVENT_ITEM, Route37HiddenEther

	db 10 ; object events
	object_event 34, 18, SPRITE_LASS, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 2, TrainerBeautyVictoria, -1
