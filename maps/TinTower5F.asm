...
TinTower5FSageScript:
	...
	checkevent EVENT_EARLS_ACADEMY_EARL
	iftrue .DuringHoOh
	checkevent EVENT_READ_5F1F_SIGN
	iftrue .Check2F
	faceplayer
	opentext
	writetext Text_5FSageNope
	waitbutton
	closetext
	end
	
.Check2F
	checkevent EVENT_READ_5F2F_SIGN
	iftrue .Check3F
	faceplayer
	opentext
	writetext Text_5FSageNope
...
.Check3F
	checkevent EVENT_READ_5F3F_SIGN
	iftrue .Check4F
	faceplayer
	opentext
	writetext Text_5FSageNope
...
.Check4F
	checkevent EVENT_READ_5F4F_SIGN
	iftrue .Check5F
	faceplayer
	opentext
	writetext Text_5FSageNope
...
.Check5F
	checkevent EVENT_READ_5F5F_SIGN
	iftrue .ReadAllSigns
	faceplayer
	opentext
	writetext Text_5FSageNope
